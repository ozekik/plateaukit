...
plateaukit generate-geojson --dataset plateau-30422-taiji-cho-2021.v2 /tmp/output.geo.json
plateaukit generate-cityjson --dataset plateau-30422-taiji-cho-2021.v2 /tmp/output.city.json

plateaukit generate-geojson --dataset plateau-30422-taiji-cho-2021.v2 /tmp/output.geo.jsonl --seq
plateaukit generate-cityjson --dataset plateau-30422-taiji-cho-2021.v2 /tmp/output.city.jsonl --seq
