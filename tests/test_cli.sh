...
# Spec v3
plateaukit install plateau-30422-taiji-cho-2021.v3 --force --local ./fixtures/30422_taiji-cho_city_2021_citygml_4_op.zip
plateaukit prebuild plateau-30422-taiji-cho-2021.v3 -t bldg

plateaukit export-geojson --dataset plateau-30422-taiji-cho-2021.v3 /tmp/output.geo.json
plateaukit export-cityjson --dataset plateau-30422-taiji-cho-2021.v3 /tmp/output.city.json

plateaukit export-geojson --dataset plateau-30422-taiji-cho-2021.v3 /tmp/output.geo.jsonl --seq
plateaukit export-cityjson --dataset plateau-30422-taiji-cho-2021.v3 /tmp/output.city.jsonl --seq

plateaukit info plateau-30422-taiji-cho-2021.v3
plateaukit info plateau-28225-asago-shi-2022.v3

# Spec v4
plateaukit install plateau-30422-taiji-cho-2021 --force --local ./fixtures/30422_taiji-cho_city_2021_citygml_5_op.zip
